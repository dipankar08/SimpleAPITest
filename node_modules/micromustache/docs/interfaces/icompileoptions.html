...
<head>
	...
	<title>ICompileOptions | MicroMustache</title>
...
<nav class="tsd-navigation secondary">
	<ul>
		...
		<li class="current tsd-kind-interface">
			<a href="icompileoptions.html" class="tsd-kind-icon">ICompile<wbr>Options</a>
			<ul>
				<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
					<a href="icompileoptions.html#explicit" class="tsd-kind-icon">explicit</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
					<a href="icompileoptions.html#propsexist" class="tsd-kind-icon">props<wbr>Exist</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="icompileoptions.html#tags" class="tsd-kind-icon">tags</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
					<a href="icompileoptions.html#validatevarnames" class="tsd-kind-icon">validate<wbr>Var<wbr>Names</a>
				</li>
			</ul>
		</li>
		<li class=" tsd-kind-interface">
			<a href="irendereroptions.html" class="tsd-kind-icon">IRenderer<wbr>Options</a>
		</li>
		<li class=" tsd-kind-interface">
			<a href="itokens.html" class="tsd-kind-icon">ITokens</a>
		</li>
	...
	<div class="content-wrap">
		<section class="tsd-panel tsd-comment">
			<div class="tsd-comment tsd-typography">
				<div class="lead">
					<p>The options that customize the tokenization of the template and the renderer
					object that is returned</p>
				</div>
			</div>
		</section>
		<section class="tsd-panel tsd-hierarchy">
			...
			<ul class="tsd-hierarchy">
				<li>
					<a href="irendereroptions.html" class="tsd-signature-type">IRendererOptions</a>
					<ul class="tsd-hierarchy">
						<li>
							<span class="target">ICompileOptions</span>
						</li>
					</ul>
				</li>
			</ul>
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section ">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-inherited"><a href="icompileoptions.html#explicit" class="tsd-kind-icon">explicit</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-inherited"><a href="icompileoptions.html#propsexist" class="tsd-kind-icon">props<wbr>Exist</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="icompileoptions.html#tags" class="tsd-kind-icon">tags</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-inherited"><a href="icompileoptions.html#validatevarnames" class="tsd-kind-icon">validate<wbr>Var<wbr>Names</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group ">
			...
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
				...
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> explicit</h3>
				<div class="tsd-signature tsd-kind-icon">explicit<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">undefined</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">false</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">true</span></div>
				<aside class="tsd-sources">
					<p>Inherited from <a href="irendereroptions.html">IRendererOptions</a>.<a href="irendereroptions.html#explicit">explicit</a></p>
					<ul>
						<li>Defined in <a href="https://github.com/userpixel/micromustache/blob/ca5dc5d/src/renderer.ts#L14">renderer.ts:14</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>When set to a truthy value, rendering literally puts a &#39;null&#39; or
							&#39;undefined&#39; for values that are <code>null</code> or <code>undefined</code>.
						By default it swallows those values to be compatible with Mustache.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
				<a name="propsexist" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> props<wbr>Exist</h3>
				<div class="tsd-signature tsd-kind-icon">props<wbr>Exist<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">undefined</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">false</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">true</span></div>
				<aside class="tsd-sources">
					<p>Inherited from <a href="irendereroptions.html">IRendererOptions</a>.<a href="irendereroptions.html#propsexist">propsExist</a></p>
					<ul>
						<li>Defined in <a href="https://github.com/userpixel/micromustache/blob/ca5dc5d/src/renderer.ts#L25">renderer.ts:25</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>When set to a truthy value, we throw a ReferenceError for invalid varNames.
						...
						If a value does not exist in the scope, two things can happen:</p>
						<ul>
							<li>if <code>propsExist</code> is truthy, the value will be assumed empty string</li>
							<li>if <code>propsExist</code> is falsy, a ReferenceError will be thrown</li>
						</ul>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				...
				<div class="tsd-signature tsd-kind-icon">tags<span class="tsd-signature-symbol">:</span> <a href="../globals.html#tokenizeoptions" class="tsd-signature-type">TokenizeOptions</a></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/userpixel/micromustache/blob/ca5dc5d/src/compile.ts#L14">compile.ts:14</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>The string symbols that mark the opening and closing of a variable name in
							the template.
			...
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
				<a name="validatevarnames" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> validate<wbr>Var<wbr>Names</h3>
				<div class="tsd-signature tsd-kind-icon">validate<wbr>Var<wbr>Names<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">undefined</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">false</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">true</span></div>
				<aside class="tsd-sources">
					<p>Inherited from <a href="irendereroptions.html">IRendererOptions</a>.<a href="irendereroptions.html#validatevarnames">validateVarNames</a></p>
					<ul>
						<li>Defined in <a href="https://github.com/userpixel/micromustache/blob/ca5dc5d/src/renderer.ts#L27">renderer.ts:27</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>when set to a truthy value, validates the variable names</p>
					</div>
				</div>
			</section>
		</section>
