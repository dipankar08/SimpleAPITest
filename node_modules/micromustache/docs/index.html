...
<head>
	...
	<title>MicroMustache | MicroMustache</title>
		...
		<div class="container">
			<div class="table-wrap">
				<div class="table-cell">
					<strong><a href="index.html">MicroMustache</a></strong>
				</div>
...
<nav class="tsd-navigation secondary">
	<ul>
		...
		<li class=" tsd-kind-interface">
			<a href="interfaces/icompileoptions.html" class="tsd-kind-icon">ICompile<wbr>Options</a>
		</li>
		<li class=" tsd-kind-interface">
			<a href="interfaces/irendereroptions.html" class="tsd-kind-icon">IRenderer<wbr>Options</a>
		</li>
		<li class=" tsd-kind-interface">
			<a href="interfaces/itokens.html" class="tsd-kind-icon">ITokens</a>
		</li>
		<li class=" tsd-kind-type-alias">
			<a href="globals.html#propnames" class="tsd-kind-icon">Prop<wbr>Names</a>
		</li>
		<li class=" tsd-kind-type-alias">
			<a href="globals.html#resolvefn" class="tsd-kind-icon">Resolve<wbr>Fn</a>
		</li>
		<li class=" tsd-kind-type-alias">
			<a href="globals.html#resolvefnasync" class="tsd-kind-icon">Resolve<wbr>FnAsync</a>
		</li>
		<li class=" tsd-kind-type-alias">
			<a href="globals.html#scope" class="tsd-kind-icon">Scope</a>
		</li>
		<li class=" tsd-kind-type-alias">
			<a href="globals.html#tokenizeoptions" class="tsd-kind-icon">Tokenize<wbr>Options</a>
		</li>
		...
		<li class=" tsd-kind-function">
			<a href="globals.html#renderfn" class="tsd-kind-icon">render<wbr>Fn</a>
		</li>
		<li class=" tsd-kind-function">
			<a href="globals.html#renderfnasync" class="tsd-kind-icon">render<wbr>FnAsync</a>
		</li>
		<li class=" tsd-kind-function">
			<a href="globals.html#topath" class="tsd-kind-icon">to<wbr>Path</a>
		</li>
		<li class=" tsd-kind-function">
			<a href="globals.html#tokenize" class="tsd-kind-icon">tokenize</a>
		</li>
	</ul>
</nav>
<div class="container container-main">
	<div class="content-wrap">
		<div class="tsd-panel tsd-typography">
			...
			<ul>
				<li><em>VarName</em>: is a string that is used in the template to refer to a value`</li>
				<li><em>Scope</em>: The object that&#39;ll be used to resolve values. <em>(In Mustache it is called View.)</em></li>
				<li><em>Rendering</em>: interpolating the varNames in a template with their value.</li>
				<li><em>Resolving</em>: looking up the value for a varName</li>
				<li><em>Compiling</em>: parsing a template and creating a renderer</li>
				<li><em>Renderer</em>: an object that holds a parsed template and have methods for rendering.</li>
				<li><em>Parsing</em>: as step during compilation for breaking a template into parts</li>
				<li><em>Tokenization</em>: going through the parsed results and creating tokens for varNames</li>
				<li><em>PropNames</em>: is an array of property names that can be used to access a nested
				property from an object.</li>
				<li><em>Stringification</em>: the process of putting everything together and creating the
				final string result <em>(in compiler slag it is called a generator)</em></li>
				<li><em>Tag</em> the strings that are used for marking varNames in the template. By default they are &#39;{{&#39; and &#39;}}&#39; respectively.</li>
			</ul>
			<p>The flow is like this:</p>
			<pre><code><span class="hljs-function"><span class="hljs-title">render</span>()</span>
  \<span class="hljs-variable">___</span> <span class="hljs-function"><span class="hljs-title">compile</span>()</span>
         |<span class="hljs-function"><span class="hljs-title">___tokenize</span>()</span>
         |       \<span class="hljs-function"><span class="hljs-title">___parse</span>()</span>
         \<span class="hljs-function"><span class="hljs-title">___resolve</span>()</span>
                \<span class="hljs-function"><span class="hljs-title">___stringify</span>()</span></code></pre>
		</div>
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section ">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-class"><a href="classes/renderer.html" class="tsd-kind-icon">Renderer</a></li>
						</ul>
					</section>
					<section class="tsd-index-section ">
						<h3>Interfaces</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-interface"><a href="interfaces/icompileoptions.html" class="tsd-kind-icon">ICompile<wbr>Options</a></li>
							<li class="tsd-kind-interface"><a href="interfaces/irendereroptions.html" class="tsd-kind-icon">IRenderer<wbr>Options</a></li>
							<li class="tsd-kind-interface"><a href="interfaces/itokens.html" class="tsd-kind-icon">ITokens</a></li>
						</ul>
					</section>
					<section class="tsd-index-section ">
						<h3>Type aliases</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-type-alias"><a href="globals.html#propnames" class="tsd-kind-icon">Prop<wbr>Names</a></li>
							<li class="tsd-kind-type-alias"><a href="globals.html#resolvefn" class="tsd-kind-icon">Resolve<wbr>Fn</a></li>
							<li class="tsd-kind-type-alias"><a href="globals.html#resolvefnasync" class="tsd-kind-icon">Resolve<wbr>FnAsync</a></li>
							<li class="tsd-kind-type-alias"><a href="globals.html#scope" class="tsd-kind-icon">Scope</a></li>
							<li class="tsd-kind-type-alias"><a href="globals.html#tokenizeoptions" class="tsd-kind-icon">Tokenize<wbr>Options</a></li>
						</ul>
					</section>
					<section class="tsd-index-section ">
						<h3>Functions</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-function"><a href="globals.html#compile" class="tsd-kind-icon">compile</a></li>
							<li class="tsd-kind-function"><a href="globals.html#get" class="tsd-kind-icon">get</a></li>
							<li class="tsd-kind-function"><a href="globals.html#render" class="tsd-kind-icon">render</a></li>
							<li class="tsd-kind-function"><a href="globals.html#renderfn" class="tsd-kind-icon">render<wbr>Fn</a></li>
							<li class="tsd-kind-function"><a href="globals.html#renderfnasync" class="tsd-kind-icon">render<wbr>FnAsync</a></li>
							<li class="tsd-kind-function"><a href="globals.html#topath" class="tsd-kind-icon">to<wbr>Path</a></li>
		...
		<section class="tsd-panel-group tsd-member-group ">
			...
			<section class="tsd-panel tsd-member tsd-kind-type-alias">
				<a name="propnames" class="tsd-anchor"></a>
				<h3>Prop<wbr>Names</h3>
				<div class="tsd-signature tsd-kind-icon">Prop<wbr>Names<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">[]</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/userpixel/micromustache/blob/ca5dc5d/src/topath.ts#L1">topath.ts:1</a></li>
					</ul>
				</aside>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-type-alias">
				...
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/userpixel/micromustache/blob/ca5dc5d/src/renderer.ts#L39">renderer.ts:39</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>The callback for resolving a value (synchronous)</p>
					</div>
					<dl class="tsd-comment-tags">
						<dt>param</dt>
						<dd><p>the scope object that was passed to .render() function</p>
						</dd>
						<dt>param</dt>
						<dd><p>variable name before being parsed.</p>
						</dd>
						<dt>example</dt>
						<dd><p>a template that is <code>Hi {{a.b.c}}!</code> leads to <code>&#39;a.b.c&#39;</code> as path</p>
						</dd>
						<dt>returns</dt>
					...
					<ul class="tsd-parameters">
						<li class="tsd-parameter-siganture">
							<ul class="tsd-signatures tsd-kind-type-literal tsd-parent-kind-type-alias tsd-is-not-exported">
								<li class="tsd-signature tsd-kind-icon"><span class="tsd-signature-symbol">(</span>varName<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span>, scope<span class="tsd-signature-symbol">?: </span><a href="globals.html#scope" class="tsd-signature-type">Scope</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">any</span></li>
							</ul>
							<ul class="tsd-descriptions">
								<li class="tsd-description">
									...
									<ul class="tsd-parameters">
										...
										<li>
											<h5><span class="tsd-flag ts-flagOptional">Optional</span> scope: <a href="globals.html#scope" class="tsd-signature-type">Scope</a></h5>
										</li>
									</ul>
			...
			<section class="tsd-panel tsd-member tsd-kind-type-alias">
				<a name="resolvefnasync" class="tsd-anchor"></a>
				<h3>Resolve<wbr>FnAsync</h3>
				<div class="tsd-signature tsd-kind-icon">Resolve<wbr>FnAsync<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">function</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/userpixel/micromustache/blob/ca5dc5d/src/renderer.ts#L44">renderer.ts:44</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Same as <code>ResolveFn</code> but for asynchronous functions</p>
					</div>
				</div>
				<div class="tsd-type-declaration">
					<h4>Type declaration</h4>
					<ul class="tsd-parameters">
						<li class="tsd-parameter-siganture">
							<ul class="tsd-signatures tsd-kind-type-literal tsd-parent-kind-type-alias tsd-is-not-exported">
								<li class="tsd-signature tsd-kind-icon"><span class="tsd-signature-symbol">(</span>varName<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span>, scope<span class="tsd-signature-symbol">?: </span><a href="globals.html#scope" class="tsd-signature-type">Scope</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">&gt;</span></li>
							</ul>
							<ul class="tsd-descriptions">
								<li class="tsd-description">
									<h4 class="tsd-parameters-title">Parameters</h4>
			...
			<section class="tsd-panel tsd-member tsd-kind-type-alias">
				...
				<h3>Scope</h3>
				<div class="tsd-signature tsd-kind-icon">Scope<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">__type</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">Function</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/userpixel/micromustache/blob/ca5dc5d/src/get.ts#L4">get.ts:4</a></li>
					</ul>
				</aside>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-type-alias">
				<a name="tokenizeoptions" class="tsd-anchor"></a>
				<h3>Tokenize<wbr>Options</h3>
				<div class="tsd-signature tsd-kind-icon">Tokenize<wbr>Options<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-symbol">[</span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">, </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">]</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/userpixel/micromustache/blob/ca5dc5d/src/tokenize.ts#L13">tokenize.ts:13</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>An array of two strings specifying the opening and closing tags that mark
		...
		<section class="tsd-panel-group tsd-member-group ">
			...
			<section class="tsd-panel tsd-member tsd-kind-function">
				...
				<ul class="tsd-signatures tsd-kind-function">
					<li class="tsd-signature tsd-kind-icon">compile<span class="tsd-signature-symbol">(</span>template<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span>, options<span class="tsd-signature-symbol">?: </span><a href="interfaces/icompileoptions.html" class="tsd-signature-type">ICompileOptions</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="classes/renderer.html" class="tsd-signature-type">Renderer</a></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/userpixel/micromustache/blob/ca5dc5d/src/compile.ts#L34">compile.ts:34</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Compiles a template and returns an object with functions that render it.
								...
								references to that object, the caches will be garbage collected.</p>
							</div>
							<dl class="tsd-comment-tags">
								<dt>throws</dt>
								<dd><p><code>TypeError</code> if the template is not a string</p>
								</dd>
								<dt>throws</dt>
								<dd><p><code>TypeError</code> if the options is set but is not an object</p>
								</dd>
								<dt>throws</dt>
								<dd><p>any error that <a href="globals.html#tokenize">tokenize</a> or <a href="classes/renderer.html#constructor">Renderer.constructor</a> may throw</p>
								</dd>
							</dl>
						</div>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								...
								<div class="tsd-comment tsd-typography">
									<p>same as the template parameter to .render()</p>
								</div>
							</li>
							<li>
								<h5><span class="tsd-flag ts-flagDefault value">Default value</span> options: <a href="interfaces/icompileoptions.html" class="tsd-signature-type">ICompileOptions</a><span class="tsd-signature-symbol"> =&nbsp;defaultCompileOptions</span></h5>
								<div class="tsd-comment tsd-typography">
									<p>some options for customizing the compilation</p>
								</div>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <a href="classes/renderer.html" class="tsd-signature-type">Renderer</a></h4>
						<p>an object with some methods that can do the actual rendering</p>
					</li>
				</ul>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-function">
				...
				<h3>get</h3>
				<ul class="tsd-signatures tsd-kind-function">
					<li class="tsd-signature tsd-kind-icon">get<span class="tsd-signature-symbol">(</span>scope<span class="tsd-signature-symbol">: </span><a href="globals.html#scope" class="tsd-signature-type">Scope</a>, varNameOrPropNames<span class="tsd-signature-symbol">: </span><a href="globals.html#propnames" class="tsd-signature-type">PropNames</a><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">string</span>, propShouldExist<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">undefined</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">false</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">true</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">any</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/userpixel/micromustache/blob/ca5dc5d/src/get.ts#L42">get.ts:42</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Similar to lodash <code>_.get()</code></p>
							</div>
							<p>Differences with JavaScript:
								No support for keys that include <code>[</code> or <code>]</code>.
								No support for keys that include <code>&#39;</code> or <code>&quot;</code> or <code>.</code>foo[bar]<code>is allowed while JavaScript treats</code>bar<code>as a variable and tries
to lookup its value or throws a</code>ReferenceError<code>if there is no variable
called</code>bar<code>.
If it cannot find a value in the specified path, it may return undefined or
throw an error depending on the value of the</code>propShouldExist` param.</p>
							<dl class="tsd-comment-tags">
								<dt>throws</dt>
								<dd><p><code>SyntaxError</code> if the varName string cannot be parsed</p>
								</dd>
								<dt>throws</dt>
								<dd><p><code>ReferenceError</code> if the scope does not contain the requested key
									but the <code>propShouldExist</code> is set to a truthy value</p>
								</dd>
							</dl>
						</div>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								<h5>scope: <a href="globals.html#scope" class="tsd-signature-type">Scope</a></h5>
								<div class="tsd-comment tsd-typography">
									<p>an object to resolve value from</p>
								</div>
							</li>
							<li>
								<h5>varNameOrPropNames: <a href="globals.html#propnames" class="tsd-signature-type">PropNames</a><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">string</span></h5>
								<div class="tsd-comment tsd-typography">
									<p>the variable name string or an array of property
									names (as returned by <code>toPath()</code>)</p>
								</div>
							</li>
							<li>
								<h5><span class="tsd-flag ts-flagOptional">Optional</span> propShouldExist: <span class="tsd-signature-type">undefined</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">false</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">true</span></h5>
								<div class="tsd-comment tsd-typography">
									<p>claiming that the varName is exists in the scope.
									It defaults to false which means we don&#39;t throw an error (like Mustachejs).</p>
								</div>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">any</span></h4>
						<p>the value or undefined. If path or scope are undefined or scope is
						null the result is always undefined.</p>
					</li>
				</ul>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-function">
				...
				<h3>render</h3>
				<ul class="tsd-signatures tsd-kind-function">
					<li class="tsd-signature tsd-kind-icon">render<span class="tsd-signature-symbol">(</span>template<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span>, scope<span class="tsd-signature-symbol">?: </span><a href="globals.html#scope" class="tsd-signature-type">Scope</a>, options<span class="tsd-signature-symbol">?: </span><a href="interfaces/icompileoptions.html" class="tsd-signature-type">ICompileOptions</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/userpixel/micromustache/blob/ca5dc5d/src/render.ts#L17">render.ts:17</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Replaces every {{varName}} inside the template with values from the scope
								parameter.</p>
							</div>
							<dl class="tsd-comment-tags">
								<dt>throws</dt>
								<dd><p>any error that <a href="globals.html#compile">compile</a> or <a href="classes/renderer.html#render">Renderer.render</a> may throw</p>
								</dd>
							</dl>
						</div>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								<h5>template: <span class="tsd-signature-type">string</span></h5>
								<div class="tsd-comment tsd-typography">
									<p>The template containing one or more {{variableName}} as
									placeholders for values from the <code>scope</code> parameter.</p>
								</div>
							</li>
							<li>
								<h5><span class="tsd-flag ts-flagOptional">Optional</span> scope: <a href="globals.html#scope" class="tsd-signature-type">Scope</a></h5>
								<div class="tsd-comment tsd-typography">
									<p>An object containing values for variable names from the the
									template. If it&#39;s omitted, we default to an empty object.</p>
								</div>
							</li>
							<li>
								<h5><span class="tsd-flag ts-flagOptional">Optional</span> options: <a href="interfaces/icompileoptions.html" class="tsd-signature-type">ICompileOptions</a></h5>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">string</span></h4>
						<p>Template where its variable names replaced with
						corresponding values.</p>
					</li>
				</ul>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-function">
				<a name="renderfn" class="tsd-anchor"></a>
				<h3>render<wbr>Fn</h3>
				<ul class="tsd-signatures tsd-kind-function">
					<li class="tsd-signature tsd-kind-icon">render<wbr>Fn<span class="tsd-signature-symbol">(</span>template<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span>, resolveFn<span class="tsd-signature-symbol">: </span><a href="globals.html#resolvefn" class="tsd-signature-type">ResolveFn</a>, scope<span class="tsd-signature-symbol">?: </span><a href="globals.html#scope" class="tsd-signature-type">Scope</a>, options<span class="tsd-signature-symbol">?: </span><a href="interfaces/icompileoptions.html" class="tsd-signature-type">ICompileOptions</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/userpixel/micromustache/blob/ca5dc5d/src/render.ts#L31">render.ts:31</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Same as <a href="classes/renderer.html#render">render</a> but accepts a resolver function which will be responsible
								for returning a value for every varName.</p>
							</div>
							<dl class="tsd-comment-tags">
								<dt>throws</dt>
								<dd><p>any error that <a href="globals.html#compile">compile</a> or <a href="classes/renderer.html#renderfn">Renderer.renderFn</a> may throw</p>
								</dd>
							</dl>
						</div>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							...
							<li>
								<h5>resolveFn: <a href="globals.html#resolvefn" class="tsd-signature-type">ResolveFn</a></h5>
							</li>
							<li>
								<h5><span class="tsd-flag ts-flagOptional">Optional</span> scope: <a href="globals.html#scope" class="tsd-signature-type">Scope</a></h5>
							</li>
			...
			<section class="tsd-panel tsd-member tsd-kind-function">
				<a name="renderfnasync" class="tsd-anchor"></a>
				<h3>render<wbr>FnAsync</h3>
				<ul class="tsd-signatures tsd-kind-function">
					<li class="tsd-signature tsd-kind-icon">render<wbr>FnAsync<span class="tsd-signature-symbol">(</span>template<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span>, resolveFnAsync<span class="tsd-signature-symbol">: </span><a href="globals.html#resolvefnasync" class="tsd-signature-type">ResolveFnAsync</a>, scope<span class="tsd-signature-symbol">?: </span><a href="globals.html#scope" class="tsd-signature-type">Scope</a>, options<span class="tsd-signature-symbol">?: </span><a href="interfaces/icompileoptions.html" class="tsd-signature-type">ICompileOptions</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">&gt;</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/userpixel/micromustache/blob/ca5dc5d/src/render.ts#L46">render.ts:46</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Same as <a href="classes/renderer.html#renderfn">renderFn</a> but only works with asynchronous resolver functions
								(a function that returns a promise instead of the value).</p>
							</div>
							<dl class="tsd-comment-tags">
								<dt>throws</dt>
								<dd><p>any error that <a href="globals.html#compile">compile</a> or <a href="classes/renderer.html#renderfnasync">Renderer.renderFnAsync</a> may throw</p>
								</dd>
							</dl>
						</div>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							...
							<li>
								<h5>resolveFnAsync: <a href="globals.html#resolvefnasync" class="tsd-signature-type">ResolveFnAsync</a></h5>
							</li>
							<li>
								<h5><span class="tsd-flag ts-flagOptional">Optional</span> scope: <a href="globals.html#scope" class="tsd-signature-type">Scope</a></h5>
							</li>
			...
			<section class="tsd-panel tsd-member tsd-kind-function">
				...
				<h3>to<wbr>Path</h3>
				<ul class="tsd-signatures tsd-kind-function">
					<li class="tsd-signature tsd-kind-icon">to<wbr>Path<span class="tsd-signature-symbol">(</span>varName<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="globals.html#propnames" class="tsd-signature-type">PropNames</a></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/userpixel/micromustache/blob/ca5dc5d/src/topath.ts#L128">topath.ts:128</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Breaks a variable name to an array of strings that can be used to get a
								particular value from an object</p>
							</div>
							<dl class="tsd-comment-tags">
								<dt>throws</dt>
								<dd><p><code>TypeError</code> if the varName is not a string</p>
								</dd>
								<dt>throws</dt>
								<dd><p><code>SyntaxError</code> if the varName syntax has a problem</p>
								</dd>
							</dl>
						</div>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								<h5>varName: <span class="tsd-signature-type">string</span></h5>
								<div class="tsd-comment tsd-typography">
									<p>the variable name as it occurs in the template.
									For example <code>a[&quot;b&quot;].c</code></p>
								</div>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <a href="globals.html#propnames" class="tsd-signature-type">PropNames</a></h4>
						<ul>
							<li>an array of property names that can be used to get a particular
								value.
			...
			<section class="tsd-panel tsd-member tsd-kind-function">
				...
				<h3>tokenize</h3>
				<ul class="tsd-signatures tsd-kind-function">
					<li class="tsd-signature tsd-kind-icon">tokenize<span class="tsd-signature-symbol">(</span>template<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span>, options<span class="tsd-signature-symbol">?: </span><a href="globals.html#tokenizeoptions" class="tsd-signature-type">TokenizeOptions</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="interfaces/itokens.html" class="tsd-signature-type">ITokens</a></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/userpixel/micromustache/blob/ca5dc5d/src/tokenize.ts#L27">tokenize.ts:27</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Parse a template and returns the tokens in an object.</p>
							</div>
							<dl class="tsd-comment-tags">
								<dt>throws</dt>
								<dd><p><code>TypeError</code> if there&#39;s an issue with its inputs</p>
								</dd>
								<dt>throws</dt>
								<dd><p><code>SyntaxError</code> if there&#39;s an issue with the template</p>
								</dd>
							</dl>
						</div>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							...
							<li>
								<h5><span class="tsd-flag ts-flagDefault value">Default value</span> options: <a href="globals.html#tokenizeoptions" class="tsd-signature-type">TokenizeOptions</a><span class="tsd-signature-symbol"> =&nbsp;defaultTokenizeOptions</span></h5>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <a href="interfaces/itokens.html" class="tsd-signature-type">ITokens</a></h4>
						<p>the resulting tokens as an object that has strings and variable names</p>
					</li>
				</ul>
			</section>
		</section>
