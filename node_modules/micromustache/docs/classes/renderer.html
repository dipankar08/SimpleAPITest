...
<head>
	...
	<title>Renderer | MicroMustache</title>
		...
		<li class="current tsd-kind-class">
			...
			<ul>
				<li class=" tsd-kind-constructor tsd-parent-kind-class">
					<a href="renderer.html#constructor" class="tsd-kind-icon">constructor</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-class tsd-is-private">
					<a href="renderer.html#options" class="tsd-kind-icon">options</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-class tsd-is-private">
					<a href="renderer.html#topathcache" class="tsd-kind-icon">to<wbr>Path<wbr>Cache</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-class tsd-is-private">
					<a href="renderer.html#tokens" class="tsd-kind-icon">tokens</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class tsd-is-private">
					<a href="renderer.html#cacheparsedpaths" class="tsd-kind-icon">cache<wbr>Parsed<wbr>Paths</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class">
					<a href="renderer.html#render" class="tsd-kind-icon">render</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class">
					<a href="renderer.html#renderfn" class="tsd-kind-icon">render<wbr>Fn</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class">
					<a href="renderer.html#renderfnasync" class="tsd-kind-icon">render<wbr>FnAsync</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class tsd-is-private">
					<a href="renderer.html#resolvevarnames" class="tsd-kind-icon">resolve<wbr>Var<wbr>Names</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class tsd-is-private">
					<a href="renderer.html#stringify" class="tsd-kind-icon">stringify</a>
				</li>
			</ul>
		</li>
	...
	<div class="content-wrap">
		<section class="tsd-panel tsd-comment">
			<div class="tsd-comment tsd-typography">
				<div class="lead">
					<p>This class does the heavy lifting of interpolation (putting the actual values
						in the template).
						This is created by the <code>.compile()</code> method and is used under the hood by
					<code>.render()</code>, <code>renderFn()</code> and <code>renderFnAsync()</code> functions.</p>
				</div>
			</div>
		</section>
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section ">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-constructor tsd-parent-kind-class"><a href="renderer.html#constructor" class="tsd-kind-icon">constructor</a></li>
						</ul>
					</section>
					<section class="tsd-index-section tsd-is-private tsd-is-private-protected">
						<h3>Properties</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-private"><a href="renderer.html#options" class="tsd-kind-icon">options</a></li>
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-private"><a href="renderer.html#topathcache" class="tsd-kind-icon">to<wbr>Path<wbr>Cache</a></li>
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-private"><a href="renderer.html#tokens" class="tsd-kind-icon">tokens</a></li>
						</ul>
					</section>
					<section class="tsd-index-section ">
						<h3>Methods</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-method tsd-parent-kind-class tsd-is-private"><a href="renderer.html#cacheparsedpaths" class="tsd-kind-icon">cache<wbr>Parsed<wbr>Paths</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class"><a href="renderer.html#render" class="tsd-kind-icon">render</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class"><a href="renderer.html#renderfn" class="tsd-kind-icon">render<wbr>Fn</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class"><a href="renderer.html#renderfnasync" class="tsd-kind-icon">render<wbr>FnAsync</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class tsd-is-private"><a href="renderer.html#resolvevarnames" class="tsd-kind-icon">resolve<wbr>Var<wbr>Names</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class tsd-is-private"><a href="renderer.html#stringify" class="tsd-kind-icon">stringify</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group ">
			...
			<section class="tsd-panel tsd-member tsd-kind-constructor tsd-parent-kind-class">
				...
				<ul class="tsd-signatures tsd-kind-constructor tsd-parent-kind-class">
					<li class="tsd-signature tsd-kind-icon">new <wbr>Renderer<span class="tsd-signature-symbol">(</span>tokens<span class="tsd-signature-symbol">: </span><a href="../interfaces/itokens.html" class="tsd-signature-type">ITokens</a>, options<span class="tsd-signature-symbol">?: </span><a href="../interfaces/irendereroptions.html" class="tsd-signature-type">IRendererOptions</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="renderer.html" class="tsd-signature-type">Renderer</a></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/userpixel/micromustache/blob/ca5dc5d/src/renderer.ts#L56">renderer.ts:56</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Creates a new Renderer instance. This is called internally by the compiler.</p>
							</div>
							<dl class="tsd-comment-tags">
								<dt>throws</dt>
								<dd><p><code>TypeError</code> if the token is invalid</p>
								</dd>
							</dl>
						</div>
						...
						<ul class="tsd-parameters">
							<li>
								<h5>tokens: <a href="../interfaces/itokens.html" class="tsd-signature-type">ITokens</a></h5>
								<div class="tsd-comment tsd-typography">
									<div class="lead">
										<p>the result of the <code>.tokenize()</code> function</p>
									</div>
								</div>
							</li>
							<li>
								<h5><span class="tsd-flag ts-flagDefault value">Default value</span> options: <a href="../interfaces/irendereroptions.html" class="tsd-signature-type">IRendererOptions</a><span class="tsd-signature-symbol"> =&nbsp;defaultRendererOptions</span></h5>
								<div class="tsd-comment tsd-typography">
									<div class="lead">
										<p>some options for customizing the rendering process</p>
									</div>
								</div>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <a href="renderer.html" class="tsd-signature-type">Renderer</a></h4>
					</li>
				</ul>
			</section>
		</section>
		<section class="tsd-panel-group tsd-member-group tsd-is-private tsd-is-private-protected">
			...
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class tsd-is-private">
				...
				<div class="tsd-signature tsd-kind-icon">options<span class="tsd-signature-symbol">:</span> <a href="../interfaces/irendereroptions.html" class="tsd-signature-type">IRendererOptions</a></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/userpixel/micromustache/blob/ca5dc5d/src/renderer.ts#L66">renderer.ts:66</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
			...
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class tsd-is-private">
				<a name="topathcache" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagPrivate">Private</span> to<wbr>Path<wbr>Cache</h3>
				<div class="tsd-signature tsd-kind-icon">to<wbr>Path<wbr>Cache<span class="tsd-signature-symbol">:</span> <a href="../globals.html#propnames" class="tsd-signature-type">PropNames</a><span class="tsd-signature-symbol">[]</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/userpixel/micromustache/blob/ca5dc5d/src/renderer.ts#L56">renderer.ts:56</a></li>
					</ul>
				...
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Another cache that holds the parsed values for <code>toPath()</code> one per varName</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class tsd-is-private">
				...
				<div class="tsd-signature tsd-kind-icon">tokens<span class="tsd-signature-symbol">:</span> <a href="../interfaces/itokens.html" class="tsd-signature-type">ITokens</a></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/userpixel/micromustache/blob/ca5dc5d/src/renderer.ts#L65">renderer.ts:65</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
		...
		<section class="tsd-panel-group tsd-member-group ">
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class tsd-is-private">
				<a name="cacheparsedpaths" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagPrivate">Private</span> cache<wbr>Parsed<wbr>Paths</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class tsd-is-private">
					<li class="tsd-signature tsd-kind-icon">cache<wbr>Parsed<wbr>Paths<span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">void</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/userpixel/micromustache/blob/ca5dc5d/src/renderer.ts#L89">renderer.ts:89</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>This function is called internally for filling in the <code>toPathCache</code> cache.
									If the <code>validateVarNames</code> option for the constructor is set to a truthy
									value, this function is called immediately which leads to a validation as
								well because it throws an error if it cannot parse variable names.</p>
							</div>
						</div>
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class">
				...
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class">
					<li class="tsd-signature tsd-kind-icon">render<span class="tsd-signature-symbol">(</span>scope<span class="tsd-signature-symbol">?: </span><a href="../globals.html#scope" class="tsd-signature-type">Scope</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/userpixel/micromustache/blob/ca5dc5d/src/renderer.ts#L108">renderer.ts:108</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
						...
						<ul class="tsd-parameters">
							<li>
								<h5><span class="tsd-flag ts-flagDefault value">Default value</span> scope: <a href="../globals.html#scope" class="tsd-signature-type">Scope</a><span class="tsd-signature-symbol"> =&nbsp;{}</span></h5>
								<div class="tsd-comment tsd-typography">
									<div class="lead">
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class">
				...
				<h3>render<wbr>Fn</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class">
					<li class="tsd-signature tsd-kind-icon">render<wbr>Fn<span class="tsd-signature-symbol">(</span>resolveFn<span class="tsd-signature-symbol">: </span><a href="../globals.html#resolvefn" class="tsd-signature-type">ResolveFn</a>, scope<span class="tsd-signature-symbol">?: </span><a href="../globals.html#scope" class="tsd-signature-type">Scope</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/userpixel/micromustache/blob/ca5dc5d/src/renderer.ts#L123">renderer.ts:123</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Same as <a href="renderer.html#render">render</a> but accepts a resolver function which will be
								responsible for returning a value for every varName.</p>
							</div>
						</div>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class">
				...
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class">
					<li class="tsd-signature tsd-kind-icon">render<wbr>FnAsync<span class="tsd-signature-symbol">(</span>resolveFnAsync<span class="tsd-signature-symbol">: </span><a href="../globals.html#resolvefnasync" class="tsd-signature-type">ResolveFnAsync</a>, scope<span class="tsd-signature-symbol">?: </span><a href="../globals.html#scope" class="tsd-signature-type">Scope</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">&gt;</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/userpixel/micromustache/blob/ca5dc5d/src/renderer.ts#L132">renderer.ts:132</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Same as <a href="renderer.html#render">render</a> but accepts a resolver function which will be responsible
								for returning promise that resolves to a value for every varName.</p>
							</div>
						</div>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class tsd-is-private">
				<a name="resolvevarnames" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagPrivate">Private</span> resolve<wbr>Var<wbr>Names</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class tsd-is-private">
					<li class="tsd-signature tsd-kind-icon">resolve<wbr>Var<wbr>Names<span class="tsd-signature-symbol">(</span>resolveFn<span class="tsd-signature-symbol">: </span><a href="../globals.html#resolvefn" class="tsd-signature-type">ResolveFn</a>, scope<span class="tsd-signature-symbol">?: </span><a href="../globals.html#scope" class="tsd-signature-type">Scope</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">[]</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/userpixel/micromustache/blob/ca5dc5d/src/renderer.ts#L141">renderer.ts:141</a></li>
							</ul>
						</aside>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class tsd-is-private">
				...
				<h3><span class="tsd-flag ts-flagPrivate">Private</span> stringify</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class tsd-is-private">
					<li class="tsd-signature tsd-kind-icon">stringify<span class="tsd-signature-symbol">(</span>values<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">[]</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/userpixel/micromustache/blob/ca5dc5d/src/renderer.ts#L160">renderer.ts:160</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Puts the resolved <code>values</code> into the rest of the template (<code>strings</code>) and
									returns the final result that&#39;ll be returned from <code>render()</code>, <code>renderFn()</code>
								and <code>renderFnAsync()</code> functions.</p>
							</div>
						</div>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
